...
public class Game implements GameControl, GameInfoProvider {
    ...
    /**
     * @return the number of invaders in the game right now
     */
    ...
    /**
     * @return the current heat level of the Player
     */
    public int getPlayerHeat() {
        return player.getHeatLevel();
    }

    /**
     * @return boolean describing the state of the Player's heat
     */
    public boolean getPlayerOverheated() {
        return player.isOverheated();
    }

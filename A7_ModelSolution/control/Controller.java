...
import newview.HeatMonitorWindow;
...
public class Controller implements KeyListener, ActionListener, GameObserver {
    ...
    /**
     * The window to show the invader image and the count of the number of invaders remaining.
     */
    private HeatMonitorWindow heatMonitorWindow;
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (actionCommand.equals("newgame")) {
            ...
            gameControl = game;
            gameInfo = game;
            gameInfo.addObserver(this); // this is passed in as a GameObserve

            // start the new window first
            heatMonitorWindow = new HeatMonitorWindow(gameInfo);
            heatMonitorWindow.setLocation(WIDTH, 0);
        ...
        if (gameInfo.isOver()) {
            ...
            Timer t = new Timer(2500, new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    heatMonitorWindow.setVisible(false);
                }
            });
            /*

...
public class DialogIO extends AbstractDialogIO {
    ...
    /**this displays a prompt and read the string entered.
     *
    ...
    /**
     * this displays a prompt and read the int entered.
     *
     * @param prompt the string to be displayed as a prompt
     * @return the int read
     */
    ...
    public static void main(String[] args) {
        ...
        dialogIO.outputString("Welcome to Wakanda cinemas...");

        int adult = dialogIO.readInt("How many adults are going to watch the movie? ");

        String[] moviesChoice = {"Eternals", "Deadpool 2", "Avengers", "Think Like a man","Black and Blue" };

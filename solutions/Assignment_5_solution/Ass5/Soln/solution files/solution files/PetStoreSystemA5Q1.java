/*
  ...
  Synopsis: Solution to Assignment 5 Question 1
 */
 ...
 */
public class PetStoreSystemA5Q1
{
    /**
    ...
    public PetStoreSystemA5Q1()
    {
        ...
        System.out.print("Enter the integer label for the first kennel: ");
        int firstKennelNumber = consoleIn.nextInt();
        consoleIn.nextLine();
        System.out.print("Enter the integer label for the last kennel: ");
    ...
    {
        System.out.println("-------Adding Animal to Store-------");
    ...
    {
        System.out.println("Showing available kennels:");
    ...
    {
        System.out.print("Enter the ID of the animal to release: ");
        String animalID = consoleIn.next();
        consoleIn.nextLine();  // get rid of the rest of the line

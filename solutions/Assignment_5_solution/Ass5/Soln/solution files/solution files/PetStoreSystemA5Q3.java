/*
  ...
  Synopsis: Solution for Assignment 5 Question 3
 */
...
public class PetStoreSystemA5Q3
{
    ...
    /**
     * The io object used for console commands
     */
    ...
    public PetStoreSystemA5Q3()
    {
        ...
        int firstKennelNumber = io.readInt("Enter the integer label for the first kennel: ");
        int lastKennelNumber = io.readInt("Enter the integer label for the last kennel: ");
    ...
    {
        io.outputString("-------Adding Animal to Store-------\n");
    ...
    public void addStaff()
    {
        ...
        io.outputString("Is the staff member a manager?");
        int selection = io.readChoice(yesNoChoices);
    ...
    {
        io.outputString("-------Showing system state-------\n");
    ...
    {
        io.outputString("-------Showing available kennels-------\n");
        ...
        {
            io.outputString(kennels.toString());
        }
    }
    ...
    {
        io.outputString("-------Releasing an animal from a kennel-------\n");
        String animalID = io.readString("Enter the ID of the animal to release: ");
    ...
    public static void main(String[] args)
    {
        ...
        sys.io.outputString("-------System running-------");
        ...
        while (systemCmd != 0)
        {
            try
            {
                systemCmd = sys.io.readChoice(menuOptions);
